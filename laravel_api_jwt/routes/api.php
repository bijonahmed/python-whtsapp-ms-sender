...
Route::group([
    ...
    Route::get('getAllMessagesAdmin', [UserController::class, 'getAllMessages']);
    Route::get('allUsers', [UserController::class, 'AllUsersList']);
    Route::get('allUsersMessages', [UserController::class, 'allUsersMessages']);
    Route::get('getUserTypeData', [UserController::class, 'getUserTypeData']);
    Route::get('getConusltant', [UserController::class, 'getConusltant']);
    Route::get('BillingRow/{id}', [UserController::class, 'BillingRow']);
    Route::get('getAllBilling', [UserController::class, 'getAllBilling']);
    Route::get('getUserBillingData', [UserController::class, 'getUserBillingData']);
    ...
    Route::get('getallscancopy', [UserController::class, 'getallscancopy']);
    Route::get('getAllMessagesrows', [UserController::class, 'getAllMessagesrows']);
    Route::get('getAllMessages', [UserController::class, 'getMessages']);
    Route::post('saveEditBilling', [UserController::class, 'saveEditBilling']);
    Route::post('editBilling', [UserController::class, 'editBilling']);
    Route::get('getallscancopyAdmin/{id}', [UserController::class, 'getallscancopyAdmin']);
    Route::get('getConsultantsocuments/{id}', [UserController::class, 'getConsultantsocuments']);
    ...
    Route::post('savePassportScan', [UserController::class, 'savePassportScan']);
    Route::post('saveTimesheetScan', [UserController::class, 'saveTimesheetScan']);
    Route::post('saveResumeScan', [UserController::class, 'saveResumeScan']);
    Route::post('saveAcademicTranscriptScan', [UserController::class, 'saveAcademicTranscriptScan']);
    Route::post('saveAcademicCertificatedScan', [UserController::class, 'saveAcademicCertificatedScan']);
    Route::post('saveProCerti', [UserController::class, 'saveProCerti']);
    Route::post('saveEmpCerti', [UserController::class, 'saveEmpCerti']);
    Route::post('saveWorkExpScan', [UserController::class, 'saveWorkExpScan']);
    Route::post('savePreviousJobOffScan', [UserController::class, 'savePreviousJobOffScan']);
    Route::post('saveLastMonthSalaryStatScan', [UserController::class, 'saveLastMonthSalaryStatScan']);
    Route::post('saveUpdateResume', [UserController::class, 'saveUpdateResume']);

    Route::get('getTimeSheets', [UserController::class, 'getTimeSheets']);
...
Route::group([
    ...
    Route::post('sendEmail', [UnauthenticatedController::class, 'sendEmail']);
